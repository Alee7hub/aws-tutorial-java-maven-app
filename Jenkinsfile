...
pipeline {
    ...
    environment {
        IMAGE_NAME = "alikakavand/demo-app:jma-1.0"
    }
    stages {
            ...
            steps {
                script {
                    ...
                    sshagent(['ec2-server-key']) {
                        sh 'scp docker-compose.yml ec2-user@18.194.233.241:/home/ec2-user'
                        sh "ssh -o StrictHostKeyChecking=no ec2-user@18.194.233.241 '${dockerComposeCmd}'"
                    }
                }
            }
        }
